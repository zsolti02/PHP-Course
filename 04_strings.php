...
$string = "Hello, I am Zsolt"; // Extract TheCodeholic into variable
$string2 = 'Hello, I am Zsolt'; // Replace TheCodeholic with variable
echo $string . '<br>';
echo $string2 . '<br>';
